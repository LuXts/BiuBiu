...
namespace BiuBiuServer.Database
{
    public class AccountDatabaseDriven : IAccountDatabaseDriven
    {
        ...
        public UnaryResult<SignInResponse> CommonSign(string signInId, string password)
        {
            throw new System.NotImplementedException();
        }

        // TODO：同上但是是管理员登录接口
        public UnaryResult<SignInResponse> AdministrantSign(string signInId, string password)
        {
            throw new System.NotImplementedException();
        }
    }
